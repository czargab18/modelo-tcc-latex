...
\section*{Dedicatórias}
\input{parte-00/04-dedicatorias}
...
\section*{Agradecimentos}
\input{parte-00/05-agradecimentos}
...
%%%%%%%%%% REFERÊNCIAS %%%%%%%%%%
\section{Referências}
\input{parte-03/00-bibliografia}
\newpage
